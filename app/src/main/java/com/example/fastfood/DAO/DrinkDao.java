...
public class DrinkDao {
    ...
    public void addDrink(Drink food, ImageView img) {
        ...
        //hành động thêm 1 loại đồ uống vào danh sách
    ...
    public void getDrink(ListView listView) {
        //lấy dữ liệu từ collection để hiện thị lên listview
        DrinkCollection.get()
    ...
    public void getNameDrink(String idDrink, TextView textView) {
        //lấy dữ liệu từ document(Drink) có giá trị là name
                            ...
                            db.collection("Food").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        //để đặt Adapter cho ListView trong Android, và tùy vào giá trị của biến top mà đặt adapter cho ListView với hoặc không hoặc với giới hạn (limit) dữ liệu được hiển thị.
                                        if (top == 0) {
                                            AdapterDrink adapterDrink = new AdapterDrink(activity, R.layout.item_lv_food, list);
                                            listView.setAdapter(adapterDrink);
                                        } else {
